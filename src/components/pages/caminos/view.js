  ...
  const onClickAddPath = async event => {
    ...
    try {
      ...
      if (respuesta.message === "success") {
        toast.success('Camino añadido. Accede a la pestaá de camino activo para editar tus etapas');
      } else {
        if (respuesta.message == "User already has an active path") {
          toast.error('Ya tienes un camino activo. Por favor, archívalo antes de añadir uno nuevo.');
        }
